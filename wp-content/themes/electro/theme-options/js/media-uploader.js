(function($) {
    $(document).ready(function() {
        ...
        function electro_add_file(event, selector) {
            ...
            frame.on('select', function() {
                ...
                selector.find('.remove-image, .remove-file').on('click', function() {
                    electro_remove_file($(this).parents('.section'));
                });
            });
        ...
        function electro_remove_file(selector) {
            ...
            selector.find('.upload-button').on('click', function() {
                electro_add_file(event, $(this).parents('.section'));
            });
        }
