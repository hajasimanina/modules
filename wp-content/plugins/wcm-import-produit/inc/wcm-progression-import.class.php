...
class WIP_Progression_Import {
	public $element_slug;
	public $element_label;
	public $labels;

	public function __construct(
		$element_slug , $element_label = "Elément" ,
		$labels = array(
        ...
        <div class="wrap ProgressActionProcessus">
            ...
            <div id="progress-bar-processus-bar" style="position:relative;height:25px;">
                <div id="progress-bar-processus-bar-percent"
                     style="position:absolute;left:50%;top:50%;width:300px;margin-left:-150px;height:25px;margin-top:-9px;font-weight:bold;text-align:center;"></div>
            </div>
            <p>
                <input type="button" class="button-primary hide-if-no-js" name="progress-bar-processus-start"
            ...
            <p>
				...
				<?php printf( 'convertis avec succès : %s' , '<span id="progress-bar-processus-debug-successcount">0</span>' ); ?>
                <br/>
